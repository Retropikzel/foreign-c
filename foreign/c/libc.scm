...
(define-c-procedure c-memset-address->pointer libc 'memset 'pointer '(u64 int int))
(define-c-procedure c-memset-pointer->address libc 'memset 'u64 '(pointer int int))
