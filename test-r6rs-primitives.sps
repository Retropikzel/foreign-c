#!r6rs
(import (rnrs base) (rnrs control) (rnrs io simple) (rnrs files) (rnrs programs) (foreign c ypsilon-primitives) (srfi :64) (only (rnrs bytevectors) make-bytevector bytevector?))
